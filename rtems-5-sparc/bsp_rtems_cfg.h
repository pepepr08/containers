...
#define CONFIGURE_APPLICATION_NEEDS_CLOCK_DRIVER /* Consider replacing with CONFIGURE_APPLICATION_DOES_NOT_NEED_CLOCK_DRIVER */
#define CONFIGURE_USE_IMFS_AS_BASE_FILESYSTEM
#define CONFIGURE_FILESYSTEM_RFS   /* Used for RAMDRIVE from osal filesys implementation */
#define CONFIGURE_FILESYSTEM_IMFS  /* Used for tarfs */
#define CONFIGURE_APPLICATION_NEEDS_LIBBLOCK
#define CONFIGURE_STACK_CHECKER_ENABLED /* Include usage data when reporting stack (stackuse shell command) */
#define CONFIGURE_MICROSECONDS_PER_TICK    10000

/*
** When running operational code, need to calculate the sum of stack sizes of all the apps
** Rough estimate of 8kB per task. Task stack varies and CONFIGURE_EXTRA_TASK_STACKS needs
** to be bigger than the sum of all the real stacks minus the min. stack size used by RTEMS
** internally.
*/
#define ESTIMATED_EXTRA_STACK       (16 * 1024)
#define CONFIGURE_EXTRA_TASK_STACKS (CONFIGURE_MAXIMUM_TASKS * (ESTIMATED_EXTRA_STACK - RTEMS_MINIMUM_STACK_SIZE))
